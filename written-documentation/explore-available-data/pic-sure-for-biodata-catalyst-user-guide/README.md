...
For more detailed information, please refer to the [Prepare for Analysis section](introduction-to-bdc-pic-sure/explore-authorized-cohort-building/prepare-for-analysis/).
...
There are a few ways to bring the selected participant-level data from BDC-PIC-SURE into one of the BDC analysis platforms, BDC-Seven Bridges or BDC-Terra. To learn more about this, please refer to the [Analysis in the BioData Catalyst Ecosystem page](prepare-for-data-analysis-using-the-pic-sure-api/analysis-in-the-bdc-ecosystem/).
